const zh = {
  ...
  summary: '摘要',
  transcriptSearchPlaceholder: '搜索字幕',
  ...
  backgroundConvertHint: '后台转换中，刷新页面可继续查看进度',
  tempCleanEmpty: '清理空记录',
  tempEmptyHint: '上传并转换后，视频将显示在下方列表中',
  tempDeleteFromList: '从列表中移除',
  tempDeleteConfirm: '确定从临时列表中移除此视频？',
  selectAll: '全选',
  clearSelection: '清空',
  tempBatchDelete: '删除选中 ({n})',
  tempBatchDeleteConfirm: '确定删除选中的 {n} 个视频？',
  tempExportCsv: '导出 CSV',
  tempDownloadTranscripts: '下载选中字幕',
  tempDownloadMerged: '合并 TXT',
  tempDownloadZip: 'ZIP 包',
  tempCopyRow: '复制字幕',
  tempDownloadRow: '下载',
  guestRemaining: '今日剩余 {n} 次',
  guestLimitReached: '游客今日已用完，请登录',
  remainingCount: '剩余 {n} 次',
  remainingMinutes: '剩余 {n} 分钟',
  usedCount: '已用 {n} 次',
  usedMinutes: '已用 {n} 分钟',
  quotaExceeded: '配额已用完',
  quotaDetails: '次数：{c}/{lc}，时长：{m}/{lm} 分钟',
  slimEntry: '极简上传',
  slimEntryDesc: '粘贴链接 → 获取字幕 → 下载带走',
  loginToUnlimit: '登录后无限制',
  converting: '转换中...',
  delete: '删除',
  convertNow: '立即转换',
  ...
  favoriteRemove: '取消收藏',
  moveToRecycle: '移至回收站',
  restoreFromRecycle: '恢复',
  removeFromRecycle: '彻底删除',
  videoPlayingOnLeft: '视频已放大至左侧播放，右侧可对照字幕与 AI 问答',
  videoClickToExpand: '点击放大播放',
  sources: '来源',
  refreshTranscript: '刷新字幕',
  transcriptRefreshHint: '若已转换字幕，请点击上方「刷新字幕」重试；或检查服务器上字幕目录是否有对应文件',
  transcriptBackendHint: '无法连接后端。本地开发请先运行：python3 api.py',
  clearChat: '清空对话',
...
const en = {
  ...
  backgroundConvertHint: 'Converting in background, refresh to continue',
  tempCleanEmpty: 'Clean empty records',
  tempEmptyHint: 'Videos will appear here after conversion',
  tempDeleteFromList: 'Remove from list',
  tempDeleteConfirm: 'Remove this video from the temp list?',
  selectAll: 'Select all',
  clearSelection: 'Clear',
  tempBatchDelete: 'Delete ({n})',
  tempBatchDeleteConfirm: 'Delete {n} selected videos?',
  tempExportCsv: 'Export CSV',
  tempDownloadTranscripts: 'Download selected transcripts',
  tempDownloadMerged: 'Merge TXT',
  tempDownloadZip: 'ZIP package',
  tempCopyRow: 'Copy transcript',
  tempDownloadRow: 'Download',
  guestRemaining: '{n} left today',
  guestLimitReached: 'Guest limit reached, please login',
  remainingCount: '{n} left',
  remainingMinutes: '{n} min left',
  usedCount: 'Used {n}',
  usedMinutes: 'Used {n} min',
  quotaExceeded: 'Quota exceeded',
  quotaDetails: 'Count: {c}/{lc}, Time: {m}/{lm} min',
  slimEntry: 'Quick Upload',
  slimEntryDesc: 'Paste links → Get transcripts → Download',
  loginToUnlimit: 'Login for unlimited',
  ...
  reportDownloadMd: 'Download Markdown',
  reportDelete: 'Delete',
  ...
  restoreFromRecycle: 'Restore',
  removeFromRecycle: 'Delete permanently',
  ...
  transcriptRefreshHint: 'If you\'ve converted the transcript, click "Refresh transcript" above; or check if the transcript files exist on the server',
  transcriptBackendHint: 'Cannot reach backend. For local dev, run: python3 api.py',
